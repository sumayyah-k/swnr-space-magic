  ...
  async getData(options) {
    ...
    return {
      ...
      ...{
        ...
        focusCasterTypePartialOptions: [
          { value: "Partial Psychic", label: "Partial Psychic" },
          { value: "Partial Arcanist", label: "Partial Arcanist" },
          { value: "Partial Magister", label: "Partial Magister" },
          { value: "Partial Pacter", label: "Partial Pacter" },
          { value: "Partial Rectifier", label: "Partial Rectifier" },
          { value: "Partial War Mage", label: "Partial War Mage" },
        ],
